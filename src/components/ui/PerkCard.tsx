...
export function PerkCard({ perk: p, index: i }: Props) {
  return (
    <motion.div
      {...fadeUp(i * 0.07)}
      className="group p-5 rounded-2xl bg-gray-100 dark:bg-[#0d0d0d] border border-gray-200 dark:border-[#1e1e1e] hover:border-[#c8956a]/30 transition-colors duration-300"
      whileHover={{ y: -3 }}
    ...
    >
      ...
      <p className="text-gray-900 dark:text-white font-bold text-sm mb-1">{p.title}</p>
